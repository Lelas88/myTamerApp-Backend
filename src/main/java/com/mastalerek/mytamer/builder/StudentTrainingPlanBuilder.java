...
public class StudentTrainingPlanBuilder extends StudentTrainingPlanBuilderBase<StudentTrainingPlanBuilder> {
	public static StudentTrainingPlanBuilder studentTrainingPlan() {
		return new StudentTrainingPlanBuilder();
	}

	public StudentTrainingPlanBuilder() {
		super(new StudentTrainingPlan());
	}

	public StudentTrainingPlan build() {
		return getInstance();
	}
}

class StudentTrainingPlanBuilderBase<GeneratorT extends StudentTrainingPlanBuilderBase<GeneratorT>> {
	private StudentTrainingPlan instance;

	protected StudentTrainingPlanBuilderBase(StudentTrainingPlan aInstance) {
		instance = aInstance;
	}

	protected StudentTrainingPlan getInstance() {
		return instance;
	}
	...
	public class StudentStudentBuilder extends StudentBuilderBase<StudentStudentBuilder> {
		...
		public GeneratorT endStudent() {
			return (GeneratorT) StudentTrainingPlanBuilderBase.this;
		}
	}
	...
	public static class TrainingPlanBuilderBase<GeneratorT extends TrainingPlanBuilderBase<GeneratorT>> {
