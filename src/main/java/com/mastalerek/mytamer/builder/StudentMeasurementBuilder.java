...
public class StudentMeasurementBuilder extends StudentMeasurementBuilderBase<StudentMeasurementBuilder> {
	public static StudentMeasurementBuilder studentMeasurement() {
		return new StudentMeasurementBuilder();
	}

	public StudentMeasurementBuilder() {
		super(new StudentMeasurement());
	}

	public StudentMeasurement build() {
		return getInstance();
	}
}

class StudentMeasurementBuilderBase<GeneratorT extends StudentMeasurementBuilderBase<GeneratorT>> {
	...
	public static class StudentBuilderBase<GeneratorT extends StudentBuilderBase<GeneratorT>> {
		...
		@SuppressWarnings("unchecked")
		public GeneratorT withBirthdate(java.util.Date aValue) {
	...
	public static class ExerciseSetBuilderBase<GeneratorT extends ExerciseSetBuilderBase<GeneratorT>> {
		...
		public AddedExercisExerciseSetExercisesBuilder withAddedExercis() {
			...
			return new AddedExercisExerciseSetExercisesBuilder(obj);
		}
	...
	public static class ExerciseSetExercisesBuilderBase<GeneratorT extends ExerciseSetExercisesBuilderBase<GeneratorT>> {
		...
		public class ExerciseExerciseBuilder extends ExerciseBuilderBase<ExerciseExerciseBuilder> {
			...
			@SuppressWarnings("unchecked")
			public GeneratorT endExercise() {
				return (GeneratorT) ExerciseSetExercisesBuilderBase.this;
			}
		}
